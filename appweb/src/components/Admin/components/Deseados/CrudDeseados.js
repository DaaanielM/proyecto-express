...
import {
	getDeseados,
	deleteDeseado,
} from '../../../services/deseados/deseadosAdm';

import FormModal from './FormModal';

function CrudDeseados() {
	...
	const eliminar = async (id_user, id_product) => {
		await deleteDeseado(id_user, id_product);
		await loadListarxd();
	};
			...
			<div className='container mt-4'>
				<div className='card'>
					<div className='card-body'>
						<span className='h3'>Listado de deseados</span>

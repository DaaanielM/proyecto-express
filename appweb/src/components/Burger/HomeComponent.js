			...
			<div className={styles.mainxd}>
				...
				<div className={styles.redes}>
					...
					<div className={styles.face}>
						<NavLink
							to={'/https://www.facebook.com/benditopecadonva'}>
							<img
								src={Fb}
								alt='Cargando imagen...'
								id={styles.fb}></img>
					...
					<div className={styles.insta}>
						<NavLink
							to={'/https://www.instagram.com/benditopecadonva'}>
							<img
								src={Ig}
								alt='Cargando imagen...'
								id={styles.ig}></img>
				...
				<main className={styles.containerxd}>
					<div className={styles.textoxd}>
						Brand Burger es un restaurante que se encuentra en la
						ciudad de Neiva, te ofrecemos productos frescos, de la
						mejor calidad. Te esperamos para que te deleites con
						nuestros productos 😋
					</div>
